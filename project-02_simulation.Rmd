...
### Simulation 4 
One statistical topic that Andy and Tanner found interesting was the probability of a certain event. One specific event we were curious about was the probability of winning the lottery. It seems like everyone always tells you not to play the lottery and that you never win any money, but we wanted to see what the probability of winning actually is. To find this probability, we ran a simulation of 1000 people playing the power ball lottery 1000 times each. In this lottery game, the goal is to guess as many balls correctly as you can. If you can guess all 5 white balls and the power ball correctly, you can win up to 40 million dollars. It costs 1 dollar to play the power ball lottery and 2 dollars for the power play power ball lottery, which has a higher jackpot prize. Meaning that if you play the normal power ball lottery 1000 times, it will cost you 1000 dollars and 2000 dollars to play power play 1000 times.
...
# creating variables for the total number of people and how many times they will play the loto for the simulation
populationNum <- 1000
totalTicket <- 1000
